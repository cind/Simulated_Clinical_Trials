...
control.formulas <- list("ADAS11" = "TOTAL11      ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "ADAS13" = "TOTAL13      ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "CDRSB"  = "CDRSB        ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "MMSE"   = "MMSE         ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "MPACC"  = "mPACCtrailsB ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "MEM"    = "ADNI_MEM     ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)",
                         "EF"     = "ADNI_EF      ~ new_time + PTEDUCAT_bl + AGE_bl +PTGENDER_bl+  (1|RID)")



enrichment.formulas <-  list(  "ADAS11"  = "TOTAL11      ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "ADAS13"  = "TOTAL13      ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "CDRSB"   = "CDRSB        ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "MMSE"    = "MMSE         ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "MPACC"   = "mPACCtrailsB ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "MEM"     = "ADNI_MEM     ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time + (1|RID)",
                               "EF"      = "ADNI_EF      ~ new_time + PTEDUCAT_bl + AGE_bl + PTGENDER_bl +  fulllewy*new_time + fullcaa*new_time + fulltdp43*new_time +  (1|RID)")
...
for(i in 1:length(baseline.enriched.data)) {
  ...
  full.treatment        <- map2(enrich.data.stratcont, sublist.long, RandomizeTreatment2, stratcolumns = c("PTEDUCAT_bl", "AGE_bl", "PTGENDER", "fulllewy", "fullcaa", "fulltdp43"))
...
names(control.models.list) <- names(control.data)
